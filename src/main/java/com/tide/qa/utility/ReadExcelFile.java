...
public class ReadExcelFile
{
	...
	//====================================================================================================
	// FunctionName    	: getTotalSaleinExcel
	// Description     	: Function to get the total number of sale required to create through excel
	// Input Parameter 	: None
	// Return Value    	: 
	//====================================================================================================
	public int getTotalSaleinExcel(String excelPath,String sheetName,String date) throws Exception
	{

		String sTotalSaleFormat=getDataFromCell(excelPath,sheetName,0,1);
		int iTotalSaleFormat=Integer.parseInt(sTotalSaleFormat);

		Report.LogInfo("ExcelSale", "Total Sale required by an Excel "+sTotalSaleFormat, "INFO");
		return iTotalSaleFormat;
	}
	...
	public void setValueinExcelCell(String xlFilePath, String sheetName,int rowNum,int colNum,int Value) 
	{
		...
		try
		{
			...
			{ 
				...
				Label l = (Label) cell; 
				l.setString(Integer.toString(Value)); 
			}
